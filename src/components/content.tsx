				...
				<Tabs value={activeTab} onValueChange={setActiveTab} className="mb-12">
					<TabsList className="grid w-full grid-cols-4 bg-white/10 ">
						<TabsTrigger value="usage"
						             className="text-white data-[state=active]:bg-neutral-200">Usage</TabsTrigger>
						<TabsTrigger value="commands"
						             className="text-white data-[state=active]:bg-neutral-200">Commands</TabsTrigger>
						<TabsTrigger value="purpose"
						             className="text-white data-[state=active]:bg-neutral-200">Purpose</TabsTrigger>
						<TabsTrigger value="contribute"
						             className="text-white data-[state=active]:bg-neutral-200">Contribute</TabsTrigger>
					</TabsList>
					<TabsContent value="usage" className="mt-6 slide-down">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							<div>
								...
								<pre id={'prebun'}
								     className="relative bg-neutral-900 h-full p-4 rounded-lg overflow-x-auto cursor-pointer"
								     onClick={
									     () => {
